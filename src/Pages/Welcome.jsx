...
import WelcomePageBanner from "../images/WelcomeAnimeBanner.jpg";
import WelcomePageImage2 from "../images/unnamed.webp";
import WelcomePageImage3 from "../images/animax.webp";
import WelcomePageImage4 from "../images/WelcomePageImage4.png";
import WelcomePageImage1 from "../images/animeBanner1.jpeg";
        ...
        <Fade>
          <div className="flex justify-center">
            <div className="flex flex-col-reverse lg:flex-row lg:items-center lg:w-9/12">
              <div className="flex justify-center">
                <img className="" src={WelcomePageImage2} style={{width:'auto', height:'300px'}}/>
              </div>
              <div>
